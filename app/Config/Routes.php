...
$routes->group('alumni', ['namespace' => 'App\Controllers\Alumni', 'filter' => 'jwt'], static function ($routes) {
    $routes->get('dashboard', 'DashboardController::index');
    $routes->get('profile', 'ProfileController::index');
});

// API Routes for Dashboard Data
$routes->group('api/alumni', ['namespace' => 'App\Controllers\Alumni', 'filter' => 'jwt'], static function ($routes) {
